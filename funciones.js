...
const productos = [
    ...
    { id:'FR002', nombre:'Naranjas Valencia', precio:1000, imagen:['assests/img/productos/naranja-valencia-1.png'], desc:'Jugosas y ricas en vitamina C, estas naranjas Valencia son ideales parazumos frescos y refrescantes. Cultivadas en condiciones climáticas óptimas que aseguran su dulzura y jugosidad.', stock:200, categoria:'Frutas Frescas'},

    { id:'FR003', nombre:'Plátanos Cavendish', precio:800,  imagen:['assests/img/productos/platanos-cavendish-1.jpg'], desc:'Plátanos maduros y dulces, perfectos para el desayuno o como snack energético. Estos plátanos son ricos en potasio y vitaminas, ideales para mantener una dieta equilibrada.', stock:250, categoria:'Frutas Frescas'},

    { id:'VR001', nombre:'Zanahorias Orgánicas', precio:900, imagen:['assests/img/productos/zanahoria-organica-1.jpg'], desc:'Zanahorias crujientes cultivadas sin pesticidas en la Región de OHiggins. Excelente fuente de vitamina A y fibra, ideales para ensaladas, jugos o como snack saludable.', stock:100, categoria:'Verduras Orgánicas' },

    { id:'VR002', nombre:'Espinacas Frescas', precio:700 , imagen:['assests/img/productos/espinacas-frescas-1.jpg'], desc:'Espinacas frescas y nutritivas, perfectas para ensaladas y batidos verdes. Estas espinacas son cultivadas bajo prácticas orgánicas que garantizan su calidad y valor nutricional.', stock:80, categoria:'Verduras Orgánicas'},

    { id:'VR003', nombre:'Pimientos Tricolores', precio:1500 , imagen:['assests/img/productos/pimiento-tricolor-1.jpg'], desc:'Pimientos rojos, amarillos y verdes, ideales para salteados y platos coloridos. Ricos en antioxidantes y vitaminas, estos pimientos añaden un toque vibrante y saludable a cualquier receta.', stock:120, categoria:'Verduras Orgánicas'},

    { id:'PO001', nombre:'Miel Orgánica', precio:5000 , imagen:['assests/img/productos/miel-organica-1.jpg'], desc:'Miel pura y orgánica producida por apicultores locales. Rica en antioxidantes y con un sabor inigualable, perfecta para endulzar de manera natural tus comidas y bebidas.', stock: 50, categoria:'Productos Orgánicos'},
